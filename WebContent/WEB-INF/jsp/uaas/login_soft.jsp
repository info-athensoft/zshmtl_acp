...
<link href="${webapp_name}/assets/global/plugins/select2/select2.css" rel="stylesheet" type="text/css"/>
<link href="${webapp_name}/assets/admin/pages/css/login-soft.css" rel="stylesheet" type="text/css"/>
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="${webapp_name}/index" method="post">
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2016 &copy; Adogo &trade; - cPanel powered by Informatique Athensoft
</div>
<!-- END COPYRIGHT -->
...
<script src="${webapp_name}/assets/admin/layout/scripts/layout.js" type="text/javascript"></script>
<script src="${webapp_name}/assets/admin/layout/scripts/demo.js" type="text/javascript"></script>
<script src="${webapp_name}/assets/admin/pages/scripts/login-soft.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
...
Layout.init(); // init current layout
  ...
  Demo.init();
       ...
       $.backstretch([
        "${webapp_name}/assets/admin/pages/media/bg/1.jpg",
        "${webapp_name}/assets/admin/pages/media/bg/2.jpg",
        "${webapp_name}/assets/admin/pages/media/bg/3.jpg",
        "${webapp_name}/assets/admin/pages/media/bg/4.jpg"
        ], {
          fade: 1000,
          duration: 8000
    }
