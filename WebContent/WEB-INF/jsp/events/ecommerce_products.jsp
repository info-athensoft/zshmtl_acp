...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic Admin Theme #2 | eCommerce Products</title>
...
<![endif]-->
   ...
   <!--  <script src="${webapp_name}/assets/pages/scripts/ecommerce-products.min.js" type="text/javascript"></script>  -->
