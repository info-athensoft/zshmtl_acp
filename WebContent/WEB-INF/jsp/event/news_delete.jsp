...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Athensoft | Event - News Delete</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
						...
						<li>
							<a href="${webapp_name}/events/news/deletelist.html">删除新闻</a>
						</li>
					</ul>
                            ...
                            <form class="form-horizontal form-row-seperated" action="#">
                                <div class="portlet">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            	删除新闻<span class="caption-helper"> </span> </div>
                                        <div class="actions btn-set">
                                            <button type="button" name="back" class="btn btn-secondary-outline" onclick="backToNewsDeleteList(); return false;">
                                                <i class="fa fa-angle-left"></i> 返回</button>
                                            
                                            <button class="btn btn-success" onclick="deleteNews(); return false;">
                                                <i class="fa fa-check"></i> 彻底删除</button>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab_general">
													...
													<div class="form-group">
														...
														<label class="col-md-10 control-label custom-label-left">${newsObject.title}</label>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">编辑: <span class="required"> * </span></label>
														<label class="col-md-10 control-label custom-label-left">${newsObject.author}</label>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<label class="col-md-10 control-label custom-label-left">${newsObject.viewNum}</label>
													</div>
													<div class="form-group">
														<label class="col-md-2 control-label">摘要: <span class="required"> * </span></label>
														<label class="col-md-10 control-label custom-label-left">${newsObject.descShort}</label>
													</div>
													
													<div class="form-group">
														<label class="col-md-2 control-label">新闻正文: <span class="required"> * </span></label>
														<label class="col-md-10 control-label custom-label-left">${newsObject.descLong}</label>
													</div>
													
													<div class="form-group">
														<label class="col-md-2 control-label">新闻类别: <span class="required"> * </span></label>
														<div class="col-md-10">
															<select class="table-group-action-input form-control input-medium" id="eventClass" name="eventClass" disabled>
													...
													<div class="form-group">
														<label class="col-md-2 control-label">新闻状态: <span class="required"> * </span>
														</label>
														<div class="col-md-10">
															<select class="table-group-action-input form-control input-medium" id="eventStatus" name="eventStatus" disabled>
                                                    ...
                                                    <table class="table table-bordered table-hover" id="event-media-table">
                                                        ...
                                                        <tbody>
															...
															<tr>
																...
																<td>
																	<input type="text" class="form-control" name="mediaLabel" value="${eventMedia.mediaLabel}" disabled="disabled">
																</td>
																<td>
																	<input type="text" class="form-control" name="sortNumber" value="${eventMedia.sortNumber}" disabled="disabled">
																</td>
																...
																<td>
																	...
																	<a href="javascript:;" onclick="return false;" class="btn default btn-sm">
