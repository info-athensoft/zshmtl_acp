        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- BEGIN THEME PANEL -->
                    <!-- END THEME PANEL -->
                    <h1 class="page-title">广告系统 <small> 修改广告</small></h1>
                    <div class="page-bar">
													...
													<div class="form-group">
														...
														<div class="col-md-10">
															<select class="table-group-action-input form-control input-medium" id="adpostStatus" name="adpostStatus">
																<option value="0" ${adPostObject.adStatus == '0' ? 'selected' : ''}>请选择...</option>
																<option value="1" ${adPostObject.adStatus == '1' ? 'selected' : ''}>已发布</option>
																<option value="2" ${adPostObject.adStatus == '2' ? 'selected' : ''}>待发布</option>
																<option value="3" ${adPostObject.adStatus == '3' ? 'selected' : ''}>已删除</option>
																<option value="4" ${adPostObject.adStatus == '4' ? 'selected' : ''}>已过期</option>
																<option value="5" ${adPostObject.adStatus == '5' ? 'selected' : ''}>审查中</option>
															</select>
														</div>
													</div>
