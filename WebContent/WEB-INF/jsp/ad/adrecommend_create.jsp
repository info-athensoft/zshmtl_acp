                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
							...
							<li>
								<a href="${webapp_name}/ad/adpost/list.html">广告</a>
								<i class="fa fa-angle-right"></i>
							</li>
							<li>
								<a href="#">新增广告</a>
                            ...
                            <form class="form-horizontal form-row-seperated" action="#">
                                <div class="portlet">
                                    <div class="portlet-title">
                                        <div class="caption">
                                           	 新增广告推荐<span class="caption-helper"> </span> </div>
                                        <div class="actions btn-set">
                                            <button type="button" name="back" class="btn btn-secondary-outline" onclick="backToAdRecommendList();return false;">
                                                <i class="fa fa-angle-left"></i> 返回列表</button>
                                            <button class="btn btn-secondary-outline" onclick="resetCreateAdRecommend();">
                                                <i class="fa fa-reply"></i> 重置</button>
                                            <button class="btn btn-success" onclick="createAdRecommend();return false; ">
                                            ...
                                            <div class="tab-content">
												...
												<div class="form-body">
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<input type="text" class="form-control" id="adUUID" name="adUUID" >
															<span class="help-block">请复制粘贴目标广告统一编号 UUID 到此</span>
														</div>
													</div>
													
													<div class="form-group">
														<label class="col-md-2 control-label">设置广告投放位置: <span class="required">* </span></label>
														<div class="col-md-4">
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<input type="text" class="form-control" id="pageName" name="pageName" readonly="readonly">
														</div>
													</div> 
													...
													<div class="form-group">
														...
														<div class="col-md-4">
															<input type="text" class="form-control" id="rcmdRank" name="rcmdRank">
...
<script>
	function setPageName(){
		...
		//alert("pageId="+pageId);
		var options=$("#pageId option:selected"); //获取选中的项
		//alert(options.val()); //拿到选中项的值
		//alert(options.text()); //拿到选中项的文本
		$("#pageName").val(options.text());
		return false;
	}
</script>
</body>
