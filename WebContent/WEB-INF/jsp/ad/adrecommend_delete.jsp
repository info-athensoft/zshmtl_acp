                                ...
                                <div class="portlet">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions btn-set">
                                            ...
                                            <button class="btn btn-success" onclick="deleteAdRecommend();">
                                    ...
                                    <div class="portlet-body">
                                        <div class="tabbable-bordered">
                                            <ul class="nav nav-tabs">
                                                <li class="active"><a href="#tab_general" data-toggle="tab"> 删除推荐设置 </a></li>
                                            </ul>
...
<script type="text/javascript" src="${webapp_name}/assets/pages/scripts-local/ad/adrecommend-delete.js"></script>
